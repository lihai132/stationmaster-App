	...
	<view class="management">
		<view class="app-header" :style="{'height': titleBarHeight,'padding-top': statusBarHeight}">
			<view class="search-block">
				<image class="black" src="../../static/icon/fanhui.png" @click="previous" mode=""></image>
			...
			<OrderNav class="OrderNav" ref="OrderList" :name="name" :listType="listType"></OrderNav>
			<u-toast ref="uToast" />
...
<script>
	...
	import OrderNav from "../../components/order/nameOrder.vue";
	...
	export default {
		...
		methods: {
			search() {
				...
				this.$refs.OrderList.getOrderList(data,1);
			...
			menuStatus(val) {
				...
				this.$store.commit("setNametype", this.listType)
